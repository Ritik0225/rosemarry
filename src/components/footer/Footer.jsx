    ...
    <>
      <div className="footer">
        <div className="footer-wrapper">
          ...
          <div className="footer_coloumn3">
            <p>Contact Information</p>
            <div className="footer_column3_container">
              <div className="footer_column3_container_icon">
                <FaHome
                  size={20}
                  style={{ color: "#fff", marginRight: "2rem" }}
                />
              </div>
              <div className="footer_column3_container_info">
